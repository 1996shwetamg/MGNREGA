...
public worker(String aadhar_number, String name, LocalDate dob, String gender, String panchayat_name, String district,
		String state) {
	super();
...
public String toString() {
	return "worker [aadhar_number=" + aadhar_number + ", name=" + name + ", dob=" + dob + ", gender=" + gender
